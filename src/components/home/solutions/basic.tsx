...
const Basic = () => {
  return (
    <div data-aos="fade-in" className='max-h-80 flex-1 bg-gradient-to-r from-[#FFC8BD] to-[#DFB9D0] flex flex-col items-center justify-center text-center gap-5 rounded-3xl p-4 backdrop-blur-xl drop-shadow-lg'>
