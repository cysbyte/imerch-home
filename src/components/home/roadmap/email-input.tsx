...
const EmailInput = () => {
    ...
    return (
        <div
            ...
            <div className={`cursor-pointer h-auto ${focused ? 'bg-black' : 'bg-[#686EFF]'} text-white rounded-full flex justify-center items-center text-base gap-1 px-3`}>
                <p className='leading-10 text-nowrap'>Book a demo</p>
