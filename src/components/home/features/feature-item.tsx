...
const FeatureItem = ({ id, title, desc }: { id: number, title: string, desc: string }) => {
    ...
    return (
        <motion.div
            ...
            className='bg-gradient-to-b from-[#FFFFFF4D] to-[#FFFFFF33] border-grad flex flex-col items-center justify-center gap-3 text-center rounded-2xl backdrop-blur-[1px] h-[220px] flex-1 p-1 border-[1px] border-gray-200/30'>
