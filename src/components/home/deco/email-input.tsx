...
const EmailInput = () => {
  return (
    <div className='flex items-center justify-center gap-8 px-2 py-1 border-[1px] border-black rounded-full'>
        <input
      ...
      />
        <div className='h-auto bg-[#686EFF] text-white rounded-full flex justify-center items-center text-base gap-1 px-3 py-1.5'>
